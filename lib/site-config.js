export const site = {
  ...
  location: {
    line1: "The Second Home Boys Hostel",
    line2: "40-Rattigan Road, Gunj Baksh Town, Lahore — Near UVAS, GCU & UOE",
    full: "The Second Home Boys Hostel, 40-Rattigan Road, Gunj Baksh Town, Lahore — Near UVAS, GCU & UOE",
  },
...
export const galleryItems = [
  ...
  },
  {
    ...
    additionalSrcs: ["/IMG-20260806-WA0089.jpg", "/WhatsApp Image 2026-08-15 at 4.41.06 PM (1).jpeg"],
  },
  {
    id: 3,
    seq: 3,
  ...
  },
  {
    ...
    additionalSrcs: ["/IMG-20260815-WA0000.jpg", "/IMG-20260806-WA0082.jpg"],
  },
  {
    id: 5,
    seq: 5,
    ...
    badge: "05. Kitchen",
    category: "kitchen",
    src: "/WhatsApp Image 2026-08-15 at 4.41.06 PM (2).jpeg",
    alt: "Resident Kitchen with Cooking Stove at The Second Home Boys Hostel Lahore",
    description:
      "Functional resident kitchen counter with gas cooking stove, stainless steel washing sink, tiled walls, and exterior window for proper ventilation.",
  ...
  },
  {
    id: 9,
    seq: 9,
    title: "Three Seater Furnished Bedroom",
    badge: "09. Three Seater",
    category: "bed",
    src: "/IMG-20260806-WA0089.jpg",
    alt: "Three Seater Furnished Student Room at The Second Home Boys Hostel Lahore",
    description:
      "Spacious shared bedroom layout complete with multiple comfortable beds, personal wardrobes, and dedicated study environment.",
    highlights: ["3 Beds Capacity", "Spacious Floor Plan", "Individual Wardrobes", "High-Speed Wi-Fi"],
  },
  {
    id: 10,
    seq: 10,
    title: "Student Wardrobe & Bed Setup",
    badge: "10. Room Setup",
    category: "bed",
    src: "/WhatsApp Image 2026-08-15 at 4.41.06 PM (1).jpeg",
    alt: "Furnished Room with Student Wardrobe and Bed at The Second Home Boys Hostel Lahore",
    description:
      "Modern bedroom setup featuring private locking wardrobes, solid wooden bed framing, and Diamond Supreme foam mattress.",
    highlights: ["Lockable Wardrobe", "Solid Bed Frame", "Diamond Foam Mattress", "Tiled Flooring"],
  },
  {
    id: 11,
    seq: 11,
    title: "Personal Storage Wardrobe",
    badge: "11. Storage",
    category: "bed",
    src: "/IMG-20260815-WA0001.jpg",
    alt: "Secure Personal Storage Wardrobe at The Second Home Boys Hostel Lahore",
    description:
      "Heavy-duty mobile wooden wardrobes with dual-door locking keys for secure clothing and luggage storage.",
    highlights: ["Dual-Door Lock", "Mobile Castor Wheels", "High Storage Capacity", "Carpeted Room"],
  },
  {
    id: 12,
    seq: 12,
    title: "Illuminated Wall Niche Gallery",
    badge: "12. Hallway Niches",
    category: "galleries",
    src: "/IMG-20260815-WA0000.jpg",
    alt: "Illuminated Hallway with Warm Wall Niches at The Second Home Boys Hostel Lahore",
    description:
      "Aesthetic gallery pathway featuring built-in warm recessed wall alcoves, skylight ventilation, and security doors.",
    highlights: ["Warm Wall Niches", "Skylight Ventilation", "Solid Security Door", "Polished Floor"],
  },
  {
    id: 13,
    seq: 13,
    title: "Clean Tiled Common Hallway",
    badge: "13. Hallway",
    category: "galleries",
    src: "/IMG-20260806-WA0082.jpg",
    alt: "Clean Tiled Common Hallway at The Second Home Boys Hostel Lahore",
    description:
      "Brightly lit, clean common corridor connecting student rooms with dedicated waste disposal and easy entrance access.",
    highlights: ["Recessed Ceiling Lights", "Non-Slip Strip Tiles", "Clean Environment", "Direct Room Access"],
  },
  {
    id: 14,
    seq: 14,
    title: "Ceramic Washbasin & Mirror Vanity",
    badge: "14. Vanity Washbasin",
    category: "washrooms",
    src: "/IMG-20260806-WA0074.jpg",
    alt: "Ceramic Pedestal Washbasin with Vanity Mirror at The Second Home Boys Hostel Lahore",
    description:
      "Clean pedestal ceramic sink station with arch vanity mirror, accessory shelf, and continuous freshwater supply.",
    highlights: ["Pedestal Ceramic Sink", "Arch Vanity Mirror", "Toiletries Shelf", "Fresh Water Tap"],
  },
]
