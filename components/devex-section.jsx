...
const STEPS = [
  ...
  },
  {
    ...
    code: [
      ...
      { type: "success", text: "✓ Cleaning & Housekeeping Services" },
      { type: "success", text: "✓ Kitchen & Home Cooked Meals" },
      { type: "success", text: "✓ CCTV & 24/7 Security" },
      { type: "success", text: "✓ Laundry Facility" },
      { type: "success", text: "✓ Filtered Drinking Water" },
      { type: "success", text: "✓ Refrigerator & Geyser" },
