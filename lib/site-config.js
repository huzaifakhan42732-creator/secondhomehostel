export const site = {
  ...
  location: {
    line1: "40-Rattigan Road, Ganj Baksh Town",
    line2: "Near UVAS, GCU & UOE",
    full: "40-Rattigan Road, Ganj Baksh Town — Near UVAS, GCU & UOE",
  },
...
export const facilities = [
  ...
  { title: "CCTV & 24/7 Security", description: "Round-the-clock CCTV surveillance and security for complete peace of mind." },
  ...
  { title: "Housekeeping Services", description: "Regular professional cleaning of rooms and common areas." },
  { title: "Refrigerator", description: "Shared refrigerator available to store food and beverages." },
