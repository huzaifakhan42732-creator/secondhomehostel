export const site = {
  ...
  tagline: "Your home away from home, near UVAS",
  description:
    "A premium, safe, and affordable hostel in Gunj Bakhsh, near UVAS — built for students and working professionals who want comfort without compromise.",
  location: {
    line1: "Gunj Bakhsh",
    line2: "Near UVAS",
    full: "Gunj Bakhsh, Near UVAS",
  },
...
export const navLinks = [
  { label: "Home", href: "/" },
  { label: "Rooms", href: "#platform" },
  { label: "Facilities", href: "#workflow" },
...
export const facilities = [
  ...
  { title: "Prime Location", description: "Walking distance from UVAS and the Gunj Bakhsh area." },
  { title: "Student Friendly", description: "Built around the real needs of students and young professionals." },
]
